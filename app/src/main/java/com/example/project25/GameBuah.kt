...
class GameBuah : AppCompatActivity(), View.OnTouchListener {
    private var dX = 0f
    private var dY = 0f
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val delapan = findViewById<ImageView>(R.id.delapan)
        ...
        delapan.setOnTouchListener(this)
